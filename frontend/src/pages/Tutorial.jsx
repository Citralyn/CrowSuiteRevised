...
function Card1() {
  return (
    <Card className="h-100">
      <Card.Img variant="top" src="pigeon_queen.png" className="card-img-responsive" />
      <Card.Body>
...
function Card2() {
  return (
    <Card className="h-100">
      <Card.Img variant="top" src="duck_king.png" className="card-img-responsive" />
      <Card.Body>
...
function Card3() {
  return (
    <Card className="h-100">
      <Card.Img variant="top" src="seagull_jack.png" className="card-img-responsive" />
      <Card.Body>
  ...
  return (
    <div className="main_bg">
      ...
      <Row className="text-center">
        <h1>How To Play CrowSuite</h1>
      </Row>
      <HGap h={"5vh"} />

<Row className="justify-content-center text-center g-4">
  <Col xs={12} md={4} className="px-5 px-md-2 mb-4">
    <Card1 />
  </Col>
  <Col xs={12} md={4} className="px-5 px-md-2 mb-4">
    <Card2 />
